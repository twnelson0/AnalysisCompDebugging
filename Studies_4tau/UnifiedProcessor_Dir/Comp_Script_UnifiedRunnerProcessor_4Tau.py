...
if __name__ == "__main__":
	...
	for n_taus in range(4,5):
        ...
        #Save coffea file
		#outfile = os.path.join(os.getcwd(), f"output_{n_taus}_boosted_tau_selec_Full4TauSamples_OldArch.coffea")
		outfile = os.path.join(os.getcwd(), f"output_{n_taus}_boosted_tau_selec_SingleMu2018A4TauSamples_OldArch.coffea")
